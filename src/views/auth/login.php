...
<div class="bg-white p-8 rounded-lg shadow-md w-96">
    ...
    <form method="POST">
        <div class="mb-4">
            ...
            <input type="text" name="email" id="email" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
        </div>
        <div class="mb-6">
